...
#define CPU_FTR_PAIRED_SINGLE		ASM_CONST(0x80000000)
...
#define CPU_FTRS_750	(CPU_FTR_COMMON | \
	    ...
	    CPU_FTR_TAU | CPU_FTR_MAYBE_CAN_NAP | \
	    CPU_FTR_PPC_LE)
#define CPU_FTRS_GEKKO	(CPU_FTRS_750 | CPU_FTR_PAIRED_SINGLE)
#define CPU_FTRS_750CL	(CPU_FTRS_750 | CPU_FTR_PAIRED_SINGLE)
...
enum {
	CPU_FTRS_POSSIBLE =
	    ...
	    CPU_FTRS_750FX2 | CPU_FTRS_750FX | CPU_FTRS_750GX | CPU_FTRS_750CL |
